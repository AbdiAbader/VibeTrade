...
class LazyStripeAPILoader {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.0", ngImport: i0, type: LazyStripeAPILoader, deps: [{ token: PLATFORM_ID }, { token: i1.WindowRef }, { token: i2.DocumentRef }], target: i0.ɵɵFactoryTarget.Injectable });
